class ModelManager {
    ...
    async getConfig() {
        ...
        if (!this.loading) {
            // adjust to your real models.json path
...
// Global hook so rag-simple.js finds it
window.loadAvailableModels = async function () {
    await window.modelManager.initializeUI();
    console.log('✅ Models loaded via loadAvailableModels');
};
