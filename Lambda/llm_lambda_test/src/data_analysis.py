...
class DocumentAnalyzer:
    ...
    def __init__(
        ...
        # Get model configuration from parameters or environment variables
        llm_model = llm_model or os.getenv("DEFAULT_LLM_MODEL", "anthropic.claude-3-sonnet-20240229-v1:0")
        embedding_model = embedding_model or os.getenv("DEFAULT_EMBEDDING_MODEL", "amazon.titan-embed-text-v2:0")
        region = region or os.getenv("BEDROCK_REGION", "ap-south-1")
        
        # Initialize loader with proper BedrockProvider configuration
        if loader is None:
    ...
    def analyze_document(
        ...
        logger.info(
            ...
            extra={"text_length": len(document_text), "doc_filename": filename},
        )
        try:
            ...
            logger.info(
                ...
                extra={"doc_filename": filename, "operation_cost_usd": operation_cost},
            )
            if operation_cost:
